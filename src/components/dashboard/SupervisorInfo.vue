<template>
    <div class="max-w-xs rounded-xl overflow-hidden shadow-lg" style="background: #E8F5E9;">

        <div class="card-header">
            <h2 class="text-lg font-bold text-center mb-3 mb-2">المسؤول عنك</h2>
        </div>
        <!-- صورة الغلاف -->
        <div class="h-32">
            <img class="w-100 object-cover" :src="bannerSrc" alt="background" />
        </div>

        <!-- صورة المسؤول -->
        <div class="d-flex justify-center" style="margin-top: -50px;">
            <img :src="avatar" alt="avatar" class="rounded-circle m-auto" width="30%" height="30%">
        </div>

        <!-- الاسم + الوصف -->
        <div class="p-4 d-flex justify-center">
            <h2 class=" m-auto text-lg font-bold">{{ name }}</h2>
        </div>
        <div class="p-3 flex justify-center gap-4 text-xl">
                        ...
                        <g>
                            <g data-name="Layer 2">
                                <g data-name="08.whatsapp">
                                    <circle cx="76" cy="76" r="76" fill="#2aa81a" opacity="1" data-original="#2aa81a"
                                        class="">
                                    </circle>
                                    <g fill="#fff">
                                        <path
        ...
        <!-- الفوتر -->
        <div class="bg-gray-100 p-2 text-center text-sm text-gray-700">
            لا تتردد بالتواصل
        </div>
    </div>
</template>
...
<script setup>
import defaultBanner from '@/assets/images/books/book-banner.png'
import fallbackAvatar from '@/assets/images/avatar/user_profile.png'
...
const bannerSrc = computed(() => props.banner || defaultBanner)
</script>